...
"List of categories affected by the multilingual synchronization. Depending on the parent feature, this list will be used as a white list (only categories allows) or as a black list (all except thoses specified)" => "List of categories affected by the multilingual synchronisation. Depending on the parent feature, this list will be used as a white list (only categories allows) or as a black list (all except thoses specified)",
...
"Blog" => "Blog",
"Force and limit categorization to within subtree of" => "Force and limit categorisation to within subtree of",
...
"Enables internationalization features and multilingual support for then entire site" => "Enables internationalisation features and multilingual support for then entire site",
"FAQ" => "FAQ",
...
"Top of center column (legacy mode)" => "Top of centre column (legacy mode)",
...
"Allows to clone a tracker on a remote host and synchronize the data locally on demand" => "Allows to clone a tracker on a remote host and synchronise the data locally on demand",
...
"Foreground Colors" => "Foreground Colours",
"Background Colors" => "Background Colours",
"Colors" => "Colours",
"Border Colors" => "Border Colours",
...
"Alignment" => "Alignment",
"Image alignment. Possible values: left, right, center. Default is left" => "Image alignment. Possible values: left, right, centre. Default is left",
"Center" => "Centre",
...
"Code" => "Code",
"Display code syntax with line numbers and color highlights" => "Display code syntax with line numbers and colour highlights",
"Caption" => "Caption",
...
"Create a jQuery-UI dialog" => "Create a jQuery-UI dialogue",
"Dialog width" => "Dialogue width",
"HTML ID" => "HTML ID",
"Wiki page to use as dialog body" => "Wiki page to use as dialogue body",
"JS to execute when dialog opens" => "JS to execute when dialogue opens",
"Div" => "Div",
...
"Horizontal alignments for header cells separated by |. Choices: left, right, center, justify" => "Horizontal alignments for header cells separated by |. Choices: left, right, centre, justify",
...
"Table body column horizontal alignments separated by |. Choices: left, right, center, justify" => "Table body column horizontal alignments separated by |. Choices: left, right, centre, justify",
...
"Download dialog box will appear for file gallery and attachment images when thumbnail is clicked" => "Download dialogue box will appear for file gallery and attachment images when thumbnail is clicked",
...
"Customize the label for the periods input. No effect if Hide Period is set to Yes (y)" => "Customise the label for the periods input. No effect if Hide Period is set to Yes (y)",
"The user " => "The user ",
...
"Use content of the wiki page as template to display the item but with as little parsing on the content as with a tpl on disk. The page should have the permission tiki_p_use_as_template set, and that page should be only open for edition to fully trusted users such as other site admins" => "Use content of the wiki page as template to display the item but with as little parsing on the content as with a tpl on disc. The page should have the permission tiki_p_use_as_template set, and that page should be only open for edition to fully trusted users such as other site admins",
"View User" => "View User",
...
"Allows to open a dialog to create new tracker items" => "Allows to open a dialogue to create new tracker items",
...
"Go to <a href=\"tiki-admin.php?page=look\" title=\"\"><strong>Look & Feel</strong></a> section for additional site related customization preferences" => "Go to <a href=\"tiki-admin.php?page=look\" title=\"\"><strong>Look & Feel</strong></a> section for additional site related customisation preferences",
...
"Your cart order has been received. Please note that orders are not finalized until payment has been made" => "Your cart order has been received. Please note that orders are not finalised until payment has been made",
...
"You can use menus by assigning the menu <a href=\"tiki-admin_modules.php\">module</a> (to the top, left, right, etc.), or you can customize a template, using {literal}{menu id=x}{/literal}, where x is the ID of the menu" => "You can use menus by assigning the menu <a href=\"tiki-admin_modules.php\">module</a> (to the top, left, right, etc.), or you can customise a template, using {literal}{menu id=x}{/literal}, where x is the ID of the menu",
...
"Extensive customizations can be made safely through the <a href=\"tiki-admin.php?page=look\" class=\"titletips\" \n\t\t\t\t\ttitle=\"Look & Feel\">Look & Feel</a> admin panel custom code or general layout areas" => "Extensive customisations can be made safely through the <a href=\"tiki-admin.php?page=look\" class=\"titletips\" \n\t\t\t\t\ttitle=\"Look & Feel\">Look & Feel</a> admin panel custom code or general layout areas",
...
"Theme Control Center: Objects" => "Theme Control Centre: Objects",
...
"Theme Control Center: Sections" => "Theme Control Centre: Sections",
...
"Theme Control Center: Categories" => "Theme Control Centre: Categories",
...
"You have less than 200 megs of free disk space. Tiki will not fit on this disk drive" => "You have less than 200MB of free disc space. Tiki will not fit on this disc drive",
"You have less than 250 megs of free disk space. This is quite tight. Tiki needs disk space for compiling templates and for uploading files" => "You have less than 250MB of free disc space. This is quite tight. Tiki needs disc space for compiling templates and for uploading files",
"When the disk runs full you will not be able to log into your Tiki any more" => "When the disk runs full you will not be able to log into your Tiki any more",
"We can not reliably check for quotas, so be warned that if your server makes use of them you might have less disk space available" => "We can not reliably check for quotas, so be warned that if your server makes use of them you might have less disc space available",
"You have more than 251 megs of free disk space. Tiki will run nicely, but you may run into issues when your site grows (e.g. file uploads)" => "You have more than 251MB of free disc space. Tiki will run nicely, but you may run into issues when your site grows (e.g. file uploads)",
