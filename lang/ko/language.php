...
"You have to enter a title and text" => "제목과 본문을 입력해야 합니다",
...
"%0 <a href=%1>replied</a> to the topic %2" => "%0님이 %2 토픽에 <a href=%1>회신하였습니다</a> ",
...
"Custom CSS class around" => "사용자 지정 CSS 클래스 around",
...
"Allow additional custom fields for article types" => "기사 종류에 대한 추가 사용자 지정 필드를 허용",
...
"Online discussions on a variety of topics. Threaded or flat." => "다양한 토픽을 다룬 온라인 토론. 쓰레드 혹은 일반방식으로 나열됨.",
...
"Custom HTML <head> Content" => "사용자 지정 HTML <head > 컨텐츠",
...
"Include a link on each page to a forum topic" => "각 페이지에 게시판 토픽 링크 포함",
"View source" => "소스 보기",
...
"Dumps" => "덤프",
"allow dumping the Site into a downloadable archive" => "사이트를 다운로드 가능한 기록 보관 파일로 덤핑을 허용",
"Wiki:" => "위키:",
...
"AutoLinks" => "자동링크",
"Tiki will automatically convert http:// and email addresses into links" => "티키는 http:// 와 이메일 주소를 링크로 자동 변환할 것입니다",
"Hotwords" => "핫워드",
...
"This needs to be checked for the parent preference to be actually enabled. This allows menu item editors to put arbitrary HTML, which could allow session hijacking; only enable if you know what you are doing" => "실제로 활성화되려면 부모 기�",
...
"Prefix must be set and unique if the same paypal account is used for different tiki sites as paypal checks that the invoice is not paid twice" => "접두어는 동일한 페이팔 계정이 다른 티키 사이트에 대하여 사용될 경우, 설정되어야만 하며 고유한 것이어여만 합니다, 이는 페이팔이 청구서가 두 번 지불되지 않았는가 확인하기 때문입니다",
...
"Displays a smiley face for simple ratings system. Only works with 0-11, depending on what you have set. An easier user-interface to use, like emoticons" => "단순 등급 시스템에 대하여 웃는 얼굴 표시. 0-11 사이에서만 작동하며 설정된 내용에 따름. 이모티콘처럼 사용 시 더욱 쉬운 사용자 인터페이스",
"Enabled" => "활성화됨",
...
"In addition to reducing the size of the CSS, reduce the number of included files." => "ㅎ",
...
"All of the content is aggregated in the contents field. For custom weighting to apply, the fields must be included in the query. This option allows to include other fields in the default content search" => "모든 컨텐",
...
"The Archive tracker must have a text field for the videoId of each archive" => "보관 트래커는 각 보관의 동영상ID를 위한 텍스트 필드를 보유해야만 합니다",
"Field ID of BrandId for Archive" => "보관을 위한 상표ID의 필드ID",
"The Archive tracker must have a text field for the BrandId of each archive" => "보관 트래커는 각 보관의 상표ID를 위한 텍스트 필드를 보유해야만 합니다",
"Field ID of ChannelCode for Archive" => "보관에 대한 채널코드의 필드 ID",
"The Archive tracker must have a text field for the ChannelCode of each archive" => "보관 트래커는 각 보관의 채널코드를 위한 텍스트 필드를 보유해야만 합니다",
"Field ID of rtmpURL for Archive (url field type)" => "보관의 rtmpURL의 필드 ID (ur<x>l 필드 유형)",
"The Archive tracker must have a url field for storing the RTMP URL to access the archive" => "기록 트래커는 보관에 접근할 RTMP URL을 저장하기 위한 URL 필드를 보유해야만 합니다",
"Field ID of flvURL for Archive (url field type)" => "보관에 대한 flvURL의 필드 ID (ur<x>l 필드 유형)",
"The Archive tracker must have a url field for storing the FLV URL to access the archive" => "보관 트래커는 보관에 접근할 FLV URL을 저장하기 위한 URL 필드를 보유해야만 합니다",
"Field ID of Date string for Archive" => "보관에 대한 날짜 문자열의 필드 ID",
"The Archive tracker can have a text field for storing the time the recording completed" => "보관 트래커는 녹음이 완료된 시간을 저장하기 위한 텍스트 필드를 보유할 수 있습니다",
"Field ID of Duration for Archive" => "보관에 대한 기간의 필드 ID",
"The Archive tracker can have a text field for storing the duration of the recording" => "보관 트래커는 녹음의 기간을 저장하기 위한 텍스트 필드를 보유할 수 있습니다",
"Field ID of Filesize for Archive" => "보관에 대한 파일크기의 필드 ID",
"The Archive tracker can have a text field for storing the filesize of the recording" => "보관 트래커는 녹음의 파일크기를 저장하기 위한 텍스트 필드를 보유할 수 있습니다",
"Field ID of Title for Archive" => "보관의 제목의 필드 ID",
"The Archive tracker could have a text field for storing the title of the recording" => "보관 트래커는 녹음의 제목을 저장히기 위한 텍스트 필드를 보유할 수 있습니다",
"Field ID of Description for Archive (textarea field type)" => "보관에 대한 설명의 필드 ID (텍스트영역 필드 유형)",
"The Archive tracker could have a textarea field for storing the description of the recording" => "보관 트래커는 녹음의 설명을 저장하기 위한 텍스트영역 필드를 보유할 수 있습니다",
"Field ID of Tags for Archive (freetags field type)" => "보관의 태그의 필드 ID (프리태그 필드 유형)",
"The Archive tracker could have a freetags field for storing the tags of the recording" => "보관 트래커는 녹음의 태그를 지정하기 위한 프리태그 필드를 보유할 수 있ㅅ브니다",
...
"Minor edits do not flag new content for translation and do not send watch notifications (unless \"Watch minor edits\" is enabled)" => "사소한 편집은 번역이 되어야할 새 컨텐츠로 표시되지 않으며 주시 알림을 보내지 않습니다 (단, \"사소한 편집 주시\" 가 활성화 된 경우는 예외)",
...
"Wiki top galleries" => "Wiki 상위 그림갤러리",
"Wiki top file galleries" => "Wiki 상위 파일갤러리",
"Wiki top images" => "Wiki 상위 그림",
...
"Failed to stored archive in tracker" => "트래커에 보관 저장 실패함",
...
"Creates a frame to assemble custom applications in. Components in the frame will be various wiki pages and modules" => "사용자 지정 응용프로그램을 조립할 프레임을 만듬. 프레임 내부의 구성 요소들이 다양항 위키 페이지 및 모듈이 될 것입니다",
...
"Custom Search Interface that displays results using the LIST plugin" => "LIST 플러그인을 사용한 결과를 표기하는 사용자 지정 검색 인터페이스",
...
"Alphanumeric Unique Identifier for search" => "검색에 대한 알파벳숫자로 된 고유 식별자",
"A unique identifier to distinguish custom searches for storing of previous search criteria entered by users" => "사용자에 의하여 입력된 이전 검색 조건을 저장하기 위한 사용자 지정 검색을 구분하기 위한 고유 식별자",
...
"Custom JavaScript wiki page" => "사용자 지정 자바스크립트 위키 페이지",
...
"Automatically generated if left empty in the form \"wpdialog_XX\" (must be unique per page)" => "\"wpdialog_XX\" 서식(페이지마다 고유하여야만 함) 에 비어둘 경우 자동으로 생성됨",
...
"Horizontal alignments for header cells separated by |. Choices: left, right, center, justify" => "| 로 구분되는 헤더 셀에 대한 가로 정렬. 선택: left, right, center, justify (좌, 우, 중앙, 양쪽 맞춤)",
...
"Table body column horizontal alignments separated by |. Choices: left, right, center, justify" => "| 으로 구분되는 표 본문 열 가로 정렬. 선택: left, right, center, justify (좌, 우, 중앙, 양측맞춤)",
...
"Example value" => "예제 값",
"Date" => "일자",
"For an archive file, the archive created just before this date will be linked to. Special values : PAGE_LAST_MOD and PAGE_VIEW_DATE" => "보관 파일에 대하여, 이 날짜 이전에 만들어진 보관은 다음에 링크될 것입니다. 특별 값 : PAGE_LAST_MOD 및 PAGE_VIEW_DATE",
"Show Icon" => "아이콘 보기",
...
"Users in specified groups, if any" => "지정되었을 경우 해당 그룹의 사용자",
"Site users" => "사이트 사용자",
...
"When only a portion of the page should be included, specify the marker from which inclusion should start" => "페이지의 일부만이 포함되어야 할 경우, 포함이 시작해야 할 곳에 표식을 지정하십시오",
"Stop" => "멈춤",
"When only a portion of the page should be included, specify the marker at which inclusion should end" => "페이지의 일부만이 포함되어야 할 경우, 포함이 끝나야 할 곳에 표식을 지정하십시오",
...
"Create lists of Tiki objects based on custom search criteria and formatting" => "사용자 지정 검색 조건과 서식에 기반한 티키 개체 목록 만들기",
...
"Email \$ Sms" => "이메일 \$ Sms",
"Button Style" => "버튼 스타일",
"Set button style: horizontal, vertical or rotate" => "버튼 스타일 설정: horizontal, vertical, rotate (가로, 세로, 회전형)",
"Rotate" => "회전",
"Rotate Image" => "그림 회전",
...
"Apply a color to the headers of your slideshow" => "슬라이드쇼의 헤더에 색상을 적용",
...
"Filters" => "필터",
"The list of fields that can be used as filters along with their formats. The field number and format are separated by a / and multile fields are separated by \":\". Format choices are: d - dropdown; r - radio buttons; m - multiple choice dropdown; c - checkbox; t - text with wild characters; T - exact text match; i - initials; sqlsearch - advanced search; >, <, >=, <= - greater than, less than, greater than or equal, less than or equal. Example" => "필터와 그의 형식과 함께 사용될 수 있는 필드의 목록. 필드번호와 형식은 / 로 구분되며 여러 개의 필드들은 \":\"로 구분됩니다. 형식에 관한 선택: d - 드롭다운; r - 라디오 버튼; m - 다항 선택 드롭다운; c - 체크상자; t - 와일드 문자로가 있는 텍스트; T - 정확히 일치하는 텍스트; i - 초기; sqlsearch - 고급 검색; >, <, >=, <= - 보다 큼, 보다 작음, 보다 크거가 같음, 보다 작거나 같음. 예제",
...
"Custom translation will not be saved. Ask your administration to change the permission." => "사용자 지정 번역이 저징되지 않을 것입니다. 관리자에게 권한을 변경하도록 요청하십시오.",
"ok" => "확인",
...
"Depending on which feature you are using, you may need some or all of the following fields to be setup" => "사용하는 기능에 따라, 다음 필드들의 일부 혹은 전부가 설정되어야할 수 있습니다",
"Shipping" => "배송",
...
"Maximum number of archives for each file:" => "각 파일의 보관의 최대숫자:",
"unlimited" => "무제한",
"Parent gallery:" => "부모 갤러리:",
...
"GalleryId" => "갤러리Id",
"Identifier" => "식별자",
"A new message was posted to forum" => "새 메지시가 다음 게시판에 게시되었습니다",
"New topic" => "새 토픽",
...
"New article submitted at %s" => "새 기사가 %s 로 투고됨",
"A new article was submitted by {\$mail_user|username} to {\$mail_site} at {\$mail_date|tiki_short_datetime:\"\":\"n\"}" => "{\$mail_user|username}님께서 {\$mail_site}로 {\$mail_date|tiki_short_datetime:\"\":\"n\"}에 새 기사를 투고하셨습니다",
...
"New forum topic in <{\$mail_forum|truncate:20:\"...\"}> by {\$mail_author|username}" => "<{\$mail_forum|truncate:20:\"...\"}> 에 {\$mail_author|username} 님에 의한 새 게시판 토픽",
...
"Group Monitor Topics of this Forum" => "이 게시판의 토픽을 그룹 모니터링",
...
"View Calendar" => "달력 보기",
"Edit Calendar" => "달력 편집",
"Custom Locations:" => "사용자 지정 위치:",
"Custom Participants:" => "사용자 지정 참여자:",
"Custom Classifications:" => "사용자 지정 분류:",
"Custom Languages:" => "사용자 지정 언어:",
"Custom URL:" => "사용자 지정 URL:",
"Custom Subscription List:" => "사용자 지정 구독 목록:",
"Custom Priorities:" => "사용자 지정 우선순위도:",
...
"Orange" => "주황",
"Yellow" => "노량",
"Custom foreground color:" => "사용자 지정 전경 색상:",
"Ex:" => "예:",
...
"hide topics preferences" => "토픽 선호설정 숨김",
...
"To use custom folder icons in menus, enter the path to the icon for the <strong>closed</strong> folder." => "메뉴에서 사용자 지정 폴더 아이콘을 사용하려면, <strong>닫힌</strong> 폴더에 대한 아이콘으로의 경로를 입력하십시오.",
...
"Multiple choices of thumbnails from a file gallery" => "파일 갤러리에서 미리보기의 다항 선택",
"Short text" => "짧은 텍스트",
...
"Excerpt" => "출처",
"Trash" => "휴지통",
"Mark entry as private" => "항목을 사적 용도로 표기",
...
"The SandBox is a page where you can practice your editing skills, use the preview feature to preview the appearance of the page, no versions are stored for this page" => "모래상자는 편집 스킬 연습용 페이지 입니다. 페이지의 외형을 미리보기하려면 미리보기 기능을 사용하십시오. 이 페이지의 어떤 버전도 저장되지 않습니다",
...
"Drop files from your desktop here or browse for them" => "바탕화면에서 여기로 파일을 드롭하거나 탐색하십시오",
...
"This is a good value for production sites. If you experience timeouts (such as when performing admin functions) you may need to increase this nevertheless" => "이는 업무용 사이트에 유용한 값입니다. 타임아웃을 경험하신 경우라면 (관리 기능을 수행할 때 등등) 그럼에도 불구하고 이를 증가해야할 수 있습니다",
...
"Tiki needs it to run PDF from URL: WebKit (wkhtmltopdf). '.\$pdf_webkit.'If you need this and trust the other PHP software on your server, you should enable it" => "티키는 PDF를 URL: WebKit (wkhtmltopdf). '.\$pdf_webkit.' 에서 실행해야 합니다. 이것이 필요하고 귀하의 서버이 다른 PHP 소프트웨어를 신뢰하는 경우, 활성화하셔야 합니다",
