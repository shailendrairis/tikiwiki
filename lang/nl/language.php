...
"Only if module" => "Alleen als het een module is",
"Always" => "Altijd",
...
"Use Tiki feature as homepage" => "Gebruik Tiki functies als startpagina",
...
"Comma-separated list, 20 characters max per entry." => "Comma-gescheiden lijst, 20 karakters max per toevoeging.",
"Bottom" => "Laagste",
"PAM service" => "PAM service",
"Currently unused" => "Momenteel niet in gebruik",
"Email address" => "E-mail adres",
"Send to URL" => "Stuur door naar de url",
"On permission denied, display login module (for Anonymous)" => "Bij geen toegangsrechten toon de aanmeldmodule (voor Anoniemen)",
...
"Sender email" => "E-mailadres van de zender",
"Database" => "Databank",
...
"Close site (except for those with permission)" => "Sluit de site (behalve voor diegenen met rechten)",
"After" => "Na",
"Before" => "Voor",
...
"Add your site to the Tiki diretory." => "Voeg je site toe aan de Tiki directory",
...
"Please see the <a class='rbox-link' target='tikihelp' href='http://doc.tiki.org/Features'>evaluation of each feature</a> on Tiki's developer site." => "Bekijk a.u.b de <a class='rbox-link' target='tikihelp' href='http://doc.tiki.org/Features'>evaluatie van elke functie</a> op de Tiki ontwikkelaars  site.",
"Apply" => "Toepassen",
"Global features" => "Globale functies",
"Main feature" => "Hoofd functies",
"Additional" => "Extra",
"Watches" => "Monitors",
...
"Release Check" => "Release controle",
...
"Go to <a href=\"tiki-admin.php?page=look\" title=\"\"><strong>Look & Feel</strong></a> section for additional site related customization preferences" => "Ga naar het <a href=\"tiki-admin.php?page=look\" title=\"\"><strong>Vormgeving</strong></a> onderdeel voor extra site-gerelateerde aanpassingen voorkeuzes.",
"Email to send a test mail" => "E-mail om een testmail te versturen",
"Menus" => "Menu's",
...
"Cookies" => "Cookies",
"Assign users to group function of email pattern" => "Wijs gebruikers toe aan groep functies van e-mail patronen",
"PAM" => "PAM",
...
"Use this page to configure the feeds generated by Tiki. To syndicate feeds from other sites, use the <strong>Admin</strong> &gt; <strong>External Feeds</strong> menu option, or" => "Gebruik deze pagina om de feeds te configureren die Tiki genereert. Om feeds van andere sites tot een syndicaat te verenigingen, gebruik het <strong>Beheer</strong> > <strong>Externe Feeds</strong> menu optie, of",
...
"Process" => "Proces",
"Please see the <a class='rbox-link' target='tikihelp' href='http://dev.tiki.org/Security'>Security page</a> on Tiki's developer site." => "Bekijk a.u.b. de <a class='rbox-link' target='tikihelp' href='http://dev.tiki.org/Security'>Beveiligingspagina</a> op de Tiki ontwikkelaars site.",
"See <a href=\"tiki-admin_security.php\" title=\"Security\"><strong>Admin &gt; Security Admin</strong></a> for additional security settings" => "zie <a href=\"tiki-admin_security.php\" title=\"Security\"><strong>Admin > Beveiligings beheer</strong></a> voor extra beveiligingsinstellingen",
...
"1 File Attached" => "1 bestand toegevoegd",
...
"Configuration search" => "Configuratie zoeken",
"Crosslinks to other features and settings" => "Kruisverwijzing naar andere eigenschappen en instellingen",
"Administration features:" => "Beheer functies:",
"TikiCache/System" => "TikiCache/Systeem",
"Transversal features" => "Transversale functies",
"which apply to more than one section" => "die betrekking hebbben op meer dan een onderdeel",
"Mail Notifications" => "E-mail meldingen",
"Navigation features:" => "Navigatie functies:",
"Text area features" => "Tekstgebied functies",
"features you can use in all text areas, like wiki pages, blogs, articles, forums, etc" => "functies die je in elk tekstgebied kunt gebruiken, zoals wiki pagina's, blog's, artikelen, forums etc.",
...
"Settings and features for freetags" => "Instellingen en functies voor freetags",
...
"%s %s successfully deleted." => "%s %s verwijderen geslaagd.",
